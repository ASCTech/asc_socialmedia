...
<div id="asc-sharing-dropdown" style="float: left;">
  ...
  <a href="https://plus.google.com/share?url=<?php print $variables['url'] ?>" id="asc-googleplus-share" class="asc-sharing-link" title="Share on Google Plus" target="_blank">Share on Google Plus</a>
  </div>
</div>
