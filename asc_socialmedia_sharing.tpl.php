<div id="asc-sharing-wrapper">
  ...
  <a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2F<?php print $variables['url'] ?>&t=<?php print $variables['title'] ?>" id="asc-facebook-share" class="asc-sharing-link" title="Share on Facebook" target="_blank" /></a>
  <a href="http://twitter.com/share?url=<?php print $variables['url'] ?>?title=<?php print $variables['title'] ?>" id="asc-twitter-share" class="asc-sharing-link" title="Share on Twitter" target="_blank"/></a>
...
<div id="asc-printemail">
  <a id="asc-print-share" href=""></a>
  <a id="asc-mail-share" href="mailto:?subject=Link&body=" 
